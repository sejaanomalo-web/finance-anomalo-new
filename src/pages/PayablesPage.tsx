...
import { usePayableMutations, usePayables } from '../hooks/useFinance';
...
export function PayablesPage() {
  ...
  const { data = [], isLoading } = usePayables(orgId);
  const mutations = usePayableMutations(orgId);
  ...
  return (
    ...
    >
      {isLoading ? (
        ...
        <EmptyState title="Sem dados reais" description="Nenhum pagamento encontrado para os filtros atuais." />
      )}
